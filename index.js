...
// ✅ Firebase Admin Setup - Fixed Version
try {
...
async function run() {
    try {
        ...
        // ✅ 1. Backend এ application create route এ date add করুন (server.js এ)
app.post('/applications', async (req, res) => {  
  const data = req.body;  
  
  // Date fields যোগ করুন
  data.applicationDate = new Date(); // ISO format এ store হবে
